...
def download_math_dataset():
    """
    Downloads the MATH dataset from EleutherAI/hendrycks_math, iterating through
    all subject configurations and saving them to the project's data directory.
    """
    # --- Configuration ---
    dataset_name = "math"
    huggingface_id = "EleutherAI/hendrycks_math"
    ...
    for config in configs:
        ...
        # Print info about the dataset splits
