...
class MathProblemPage extends StatefulWidget {
  final List<dynamic> problems;
  final int startingIndex;
  final String pageTitle;

  const MathProblemPage({
    super.key,
  ...
  @override
  State<MathProblemPage> createState() => _MathProblemPageState();
}

class _MathProblemPageState extends State<MathProblemPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final questionWithAsy =
        problem['problem']?.toString() ?? 'No question available.';
    final question = questionWithAsy.replaceAll(
        RegExp(r'\[asy\].*?\[/asy\]', dotAll: true), '');
    final answer = problem['solution']?.toString() ?? 'No answer available.';
          ...
          children: [
            ...
            Center(
              child: ElevatedButton(
                ...
                child: Text(_showAnswer ? 'Hide Solution' : 'Show Solution'),
              ),
            ),
          ],
        ),
